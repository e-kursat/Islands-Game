...
public class CameraManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            _cameraRotation.Yaw += _input.x * mouseSensitivity.horizontal * 
                                   BoolToInt(mouseSensitivity.invertHorizontal) * 
                                   Time.deltaTime;
            _cameraRotation.Pitch += _input.y * mouseSensitivity.vertical * 
                                     BoolToInt(mouseSensitivity.invertVertical) * 
                                     Time.deltaTime;
            _cameraRotation.Pitch = Math.Clamp(_cameraRotation.Pitch, cameraAngle.min, cameraAngle.max);
        }
    }
