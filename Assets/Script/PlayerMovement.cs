...
public class PlayerMovement : MonoBehaviour
{
    ...
    void InputMove()
    {
        Anim.SetFloat("Speed", Vector3.ClampMagnitude(StickDirection, _maxSpeed).magnitude, 
            damp, Time.deltaTime * 10);
    }
    ...
    // Yer çekimini ve zıplama için eklenen kuvvetin hesaplandığı fonksiyon
    void HandleGravity()
    {
